...
public class Receipt extends JFrame implements Runnable, ActionListener, Serializable {
	...
	public Receipt() {
	    ...
	    lblNewLabel_5.setBounds(34, 345, 151, 18);
	    tablePanel.add(lblNewLabel_5);
		 ...
		 case 1:
				...
				for(int i=0;i<GUITest.MenuNum;i++)
				{
					...
					lblNewLabel_3.setText("받은금액 : "+Integer.toString(CashListener.get_money));
					lblNewLabel_5.setText("거스름돈 : "+Integer.toString(CashListener.change));
